...
private MFVec3f m_set_normal;
private MFInt32 m_set_coordIndex;
private MFInt32 m_set_normalIndex;
////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
		...
		// the events
		//will have to use the "twoslitnotsure.vrml" file from the old version...GREAT naming convention
		m_set_point = (MFVec3f) sai.getInputField("slitCoordinateNode","set_point");

		// coordIndices
		m_set_coordIndex =
			(MFInt32) sai.getInputField("slitIFSNode","set_coordIndex");
		m_set_normalIndex =
			(MFInt32) sai.getInputField("slitIFSNode","set_normalIndex");
	}
...
////////////////////////////////////////////////////////////////////
	...
	public boolean evaluate() {
		...
		//This probably won't work and will have to change to SFInt32 or SFFloat32
		m_set_coordIndex.setValue(0,empty); //requires 2 arguments..not sure what the first is for [JD]
		m_set_point.setValue(0,point);
		m_set_coordIndex.setValue(0,coordIndices);
